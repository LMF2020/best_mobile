/// Zoom Options required for iOS, Android
class ZoomOptions {
  String? domain;
...
class ZoomInitError {
  static const int ZOOM_ERROR_SUCCESS = 0;
  static const int ZOOM_ERROR_INVALID_ARGUMENTS = 1;
  static const int ZOOM_ERROR_ILLEGAL_APP_KEY_OR_SECRET = 2;
  static const int ZOOM_ERROR_NETWORK_UNAVAILABLE = 3;
  static const int ZOOM_ERROR_AUTHRET_CLIENT_INCOMPATIBLEE = 4;
  static const int ZOOM_ERROR_AUTHRET_TOKENWRONG = 5;
  static const int ZOOM_ERROR_DEVICE_NOT_SUPPORTED = 99;
  static const int ZOOM_ERROR_UNKNOWN = 100;
  static const int ZOOM_AUTO_LOGIN_SUCCESS = 200;
}
