...
class ScheduleMeetingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('meeting.schedule'.tr),
        centerTitle: true,
        leading: IconButton(
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              if (_formKey.currentState!.validate()) {
                String? hostId = state.loginUser.value.id;
                ...
                ScheduleOptions scheduleOpt = ScheduleOptions(
                  ...
                  topic,
                  startTime,
                  timeZone: state.timeZoneSelected.value,
                  duration: duration,
                  password: password,
                ...
                onSuccess(Meeting m) {
                  ...
                  Get.snackbar(
                    ...
                    "toast.schedule_meeting.submit.success".tr,
                ...
                onFail(error) {
                  ...
                  controller.failAlert(
                      'toast.schedule_meeting.submit.fail', error.toString());
                }

                CommonUI.showConfirmationAlertDialog(
                  context,
                  title: 'title.schedule_meeting.submit'.tr,
                  middleText: 'confirm.schedule_meeting.submit'.tr,
                  cancelText: 'btn.cancel'.tr,
                  confirmText: 'btn.confirm'.tr,
                  onConfirm: () {
                    controller.scheduleMeeting(scheduleOpt, onSuccess, onFail);
                  },
                );
              }
            },
