...
@objc class AppDelegate: FlutterAppDelegate, FlutterStreamHandler {
    ...
    var productName = "百佳会";
    var appGroupID = "group.com.bestMobile.meeting"
...
extension AppDelegate {
    ...
    func initialiseSDK(arguments: Dictionary<String, String>, result: @escaping FlutterResult) {
        ...
        // 设置语言，// 使用 `en` 作为默认值
        var locale = arguments["locale"] ?? "en"
        print("initSDK:: current language locale is \(locale)")
...
extension AppDelegate: MobileRTCMeetingServiceDelegate {
    ...
    func onClickShareScreen(_ parentVC: UIViewController) {
        ...
        broadcastView.preferredExtension = "com.bestMobile.meeting.ScreenShare"
